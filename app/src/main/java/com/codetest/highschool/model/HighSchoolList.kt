package com.codetest.highschool.model

// data class HighSchoolListItem
// according to JSON response
data class HighSchoolListItem(val dbn: String, val school_name: String, val boro: String, val overview_paragraph: String,
